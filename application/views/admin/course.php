  ...
  <div class="card mb-4 wow fadeIn">
    <div class="card-body d-sm-flex justify-content-between">
      ...
      <h4 class="mb-2 mb-sm-0 pt-1 float-right">
        <span><a href="<?php echo base_url();?>admin/course-archive">Archive</a></span>
      </h4>
    </div>
  </div>
  <div class="row">
                ...
                <tr>
                  ...
                  <td>
                    <div class="input-group mb-3">
                      ...
                      <a class="btn btn-sm btn-success" href='<?php echo base_url(); ?>admin/course/<?php echo $course['slug'];?>'>View</a>
                      <a class="btn btn-sm btn-primary edit_course" data-id="<?php echo $course['course_ID']; ?>">Edit</a>
                      </div>
                    </div>
                  </td>
                </tr>
