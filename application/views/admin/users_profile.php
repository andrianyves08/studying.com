      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div>
            ...
            ?>
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#change_password">Change Password</button>
            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#change_email_modal">Change Email</button>
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#enroll_student_modal">Enroll Student</button>
            <?php if($users['role'] != '1'){?>
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#make_as_instructor_modal">Make as Instructor</button>
            <?php } ?>
          </div>
        </div>
      </div>
            ...
            <tbody>
              <?php foreach ($users_course as $module) {?>
                <tr>
                  ...
                  <td><?php echo date("F d, Y h:i A", strtotime($module['date_enrolled']));?></td>
                  <td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="user_ID" value="<?php echo $users['id'];?>">
        </div>
        <div class="form-group">
...
<!-- Enroll Student -->
<div data-backdrop="static" class="modal fade" id="make_as_instructor_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-notify modal-info modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <p class="heading lead">Make as Instructor</p>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="white-text">&times;</span>
        </button>
      </div>
        ...
        <div class="modal-body mx-3">
          <div class="news-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control rounded-0" name="description" id="description" rows="3" placeholder="Describe course" required></textarea>
            </div>
            <div class="form-group">
              <label>Experience (Optional)</label>
              <textarea class="form-control rounded-0" name="experience" id="experience" rows="3" placeholder="Describe experience as an instructor"></textarea>
            </div>
          </div><!--News-->
        </div>
        <div class="modal-footer justify-content-center">
          <a type="button" class="btn btn-danger waves-effect" data-dismiss="modal">Cancel</a>
          <button class="btn btn-success waves-effect float-right" type="submit">Save Status</button>
        </div>
      <?php echo form_close(); ?>
    </div>
  </div>
...
$(document).ready(function(){
  ...
  $('#submit_enrollment').on('click',function(){
    ...
    $.ajax({
      ...
      dataType : "JSON",
      data : {user_ID:user_ID, course_ID:course_ID, status:status, comment:comment, admin_ID:<?php echo $admin_id?>},
      success: function(data){
